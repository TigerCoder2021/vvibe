...
export const SendIcon: React.FC<SendIconProps> = ({ isActive }) => (
...
export const HomeIcon: React.FC<NavIconProps> = ({ active }) => (
...
export const ChatIcon: React.FC<NavIconProps> = ({ active }) => (
  <svg className={`w-6 h-6 ${active ? 'text-white' : 'text-gray-500'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
  </svg>
);

export const ProfileIcon: React.FC<NavIconProps> = ({ active }) => (
  <svg className={`w-6 h-6 ${active ? 'text-white' : 'text-gray-500'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
// Voice Waveform Icon (4-5 vertical bars)
export const VoiceWaveIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <rect x="3" y="8" width="2.5" height="8" rx="1.25" />
    <rect x="7.5" y="4" width="2.5" height="16" rx="1.25" />
    <rect x="12" y="6" width="2.5" height="12" rx="1.25" />
    <rect x="16.5" y="9" width="2.5" height="6" rx="1.25" />
